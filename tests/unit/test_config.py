...
from core.config import ConfigLoader, OracleSettings, SettingsSerializer
...
class TestOracleSettings:
    ...
    def test_nats_timeout_negative_raises(self):
        with pytest.raises(ValidationError):
            OracleSettings(nats={"timeout": -1})
...
class TestConfigLoader:
    ...
    def test_load_yaml_override(self, tmp_path):
...
class TestSettingsSerializer:
    ...
    def test_to_toml_missing_dep_raises(self):
        settings = OracleSettings()
